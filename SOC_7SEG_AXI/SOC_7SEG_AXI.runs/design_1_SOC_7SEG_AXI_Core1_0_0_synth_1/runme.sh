...
HD_PWD='C:/DevWorks/SOC_7SEG_AXI/SOC_7SEG_AXI.runs/design_1_SOC_7SEG_AXI_Core1_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_SOC_7SEG_AXI_Core1_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_SOC_7SEG_AXI_Core1_0_0.tcl
