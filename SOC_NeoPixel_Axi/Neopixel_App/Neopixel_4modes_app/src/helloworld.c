    ...
    while (1) {
        if (btn_flag) {
           current_mode = __builtin_ctz(btn_flag);
            ...
            switch (current_mode) {
                case 0: step_color_cycle();     break;
                case 1: step_running_light();   break;
                case 2: step_rainbow_cycle();   break;
                case 3: step_border_blink();    break;
                default: step_color_cycle();	break;
            }
            usleep(100000);
        }
