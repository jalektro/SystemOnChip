...
HD_PWD='C:/DevWorks/SOC_NeoPixel_Axi/SOC_NeoPixel_Axi.runs/design_1_SOC_NeoPixel_AXI_Core_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_SOC_NeoPixel_AXI_Core_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_SOC_NeoPixel_AXI_Core_0_0.tcl
